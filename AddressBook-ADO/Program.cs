...
namespace AddressBook_ADO
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            AddressBookBuider addressBook = new AddressBookBuider(); //Object

            //Display Messages
            Console.WriteLine("Press 1 :: To Work on Existing Address Book ::");
            Console.WriteLine("Press 2 :: To Add New Address Book ::");
            Console.WriteLine("--------------------------------------------");
